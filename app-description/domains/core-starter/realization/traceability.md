...
| User Admin SaaS Owner Admin branch | `app-description/domains/core-starter/workstreams/user-admin/surfaces/surfaces.md`, `app-description/domains/core-starter/capabilities/user-and-access-administration.md` | New intent requires implementation follow-up for SaaS Owner Admin list/invite/manage surfaces, APIs, last-owner-admin protection, invitation/outbox integration, and safe Tenant/Customer denial. |
...
| User Admin Organization Admin branch | `app-description/domains/core-starter/workstreams/user-admin/surfaces/surfaces.md`, `app-description/55-ui/frontend-api-contracts.md` | New intent requires implementation follow-up for Organization Admin list/invite/bootstrap/detail/manage surfaces and APIs under a selected Organization/Tenant, including `TENANT_ADMIN` role validation, invitation/outbox integration, last-organization-admin protection, and no tenant app-data/support/billing authority by implication. |
| User Admin Customer and Customer Admin branch | `app-description/domains/core-starter/workstreams/user-admin/surfaces/surfaces.md`, `app-description/55-ui/frontend-api-contracts.md` | New intent requires implementation follow-up for Customer list/create/detail/lifecycle plus Customer Admin list/invite/bootstrap/detail/manage surfaces and APIs under selected Organization/Tenant and Customer scope, including `CUSTOMER_ADMIN` role validation, invitation/outbox integration, last-customer-admin protection, and no sibling-customer/Organization Admin/SaaS Owner authority by implication. |
| User Admin surface conformance cleanup | `app-description/domains/core-starter/workstreams/user-admin/workstream.md`, `app-description/domains/core-starter/workstreams/user-admin/surfaces/surfaces.md`, `specs/user-admin-surface-conformance-cleanup/conformance-specification.md` | Mini-project `specs/user-admin-surface-conformance-cleanup/**`; implementation follow-up must preserve canonical surface types, backend-authored dashboard/list routing and options, `user-admin-agent` with `agent-user-admin` alias compatibility, inspection-only detail surfaces, typed `surface-user-admin-system-message` outcomes, diagnostic metadata redaction, and no inline mutation controls in normal User Admin detail/runtime paths. |
