...
- Given an allowed action, when it is submitted with valid input, then capability `governance-policy-lifecycle` returns the expected structured result and emits required traces.
