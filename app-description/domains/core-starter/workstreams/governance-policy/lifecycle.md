...
Last description change: 2026-06-26 — reconciled Governance/Policy with current skills-pack worker, adapter, governed-tool, surface, and lifecycle doctrine.
...
- Compile-ready means app-description scope is sufficient for focused build/compile tasks, but implementation alignment remains stale until a source-alignment review and checks pass.
