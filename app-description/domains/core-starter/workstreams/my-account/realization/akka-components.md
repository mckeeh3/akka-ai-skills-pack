...
Capability `account-context-and-profile` should remain traceable to protected Akka endpoints/services/entities/views/agents/workflows as applicable in later realization mapping. Known implementation evidence is in `specs/app-description-intent-compiler-migration/source-inventory.md`.
