...
Data-state nodes describe durable state responsibilities, lifecycle rules, invariants, retention, and trace obligations for the built-in core starter domain.
...
- `workstream-audit-governance-state.md` — workstream logs, audit/admin events, traces, exports, investigation notes, policy proposals, simulations, decisions, and governance outcomes.
