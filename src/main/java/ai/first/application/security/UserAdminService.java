...
public final class UserAdminService {
  ...
  void auditAccessReview(AuthContextResolver.ResolvedMe actor, ai.first.domain.security.AccessReviewTask task, String action, AdminAuditEvent.Result result, String reason, String correlationId) {
