...
public class Validator {
  ...
  public record ValidatorBuilder(List<String> reasons) {
    ...
    public ValidatorBuilder isLtEqZero(BigDecimal test, String reason) {
    ...
    public ValidatorBuilder isGtLimit(BigDecimal test, BigDecimal limit, String reason) {
      return test.compareTo(limit) > 0 ? addError(reason) : this;
    }
