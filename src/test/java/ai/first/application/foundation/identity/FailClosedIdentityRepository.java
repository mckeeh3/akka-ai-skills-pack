...
public final class FailClosedIdentityRepository implements IdentityRepository {
  ...
  @Override public void deleteAccount(String accountId) { throw unavailable(); }
  ...
  @Override public void deleteProfile(String accountId) { throw unavailable(); }
  ...
  @Override public void deleteSettings(String accountId) { throw unavailable(); }
  ...
  @Override public void deleteMembership(String membershipId) { throw unavailable(); }
