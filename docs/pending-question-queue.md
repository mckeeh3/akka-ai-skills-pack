...
5. For generated full-stack AI-first SaaS, if no style guide is selected, add a `category: ui` style-selection question using `docs/web-ui-style-guide.md`; it should block web UI implementation/generation work until answered.
