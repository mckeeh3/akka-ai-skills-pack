...
Use the user's actual domain name for `<domain>`.
...
- If core behavior must be extended, add a small registry or hook in core code and keep domain implementation under the extension path.
