...
- files expected to apply this guide: generated React/Vite frontend CSS, shell/navigation components, foundation administration surfaces, supplies autopilot workstream UI, decision-card detail UI, shipment trace drawer, API state rendering, static hosting assets, and frontend smoke tests for any future DCA realization slice
