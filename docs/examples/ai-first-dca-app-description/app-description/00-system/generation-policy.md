...
- External integration assumptions must identify whether the generated slice uses a production provider, local captured adapter, deterministic fixture, or explicit stub.
