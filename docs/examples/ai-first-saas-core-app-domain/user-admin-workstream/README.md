...
- **Minimum starter role:** the smallest valid generated app may begin with User Admin workstream v0 using `markdown_response`, but full-core readiness requires the surfaces/capabilities below
