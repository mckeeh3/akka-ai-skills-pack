...
| `user_admin` | `user-admin-workstream/` | `functional_agent.user_admin` | all full-core generated apps; minimum starter may begin here as v0 | users, invitations, memberships, roles/capabilities, disabled access, access review, support-access visibility |
