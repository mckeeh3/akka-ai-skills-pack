...
- allowed actions:
  ...
  - invoke `readSkill(skillId)` test console → `managed-agent-foundation`
- states:
...
- rendering tests:
  - proposed diff review, unassigned skill denial, authority-expansion denial, activation approval, trace-link rendering.
