...
| `InvitationDraftAgent` | User Admin invite form | Draft invite copy and role rationale. | No token visibility; no autonomous invitation creation. | no-token exposure, draft-only behavior. |
