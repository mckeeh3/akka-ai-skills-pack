...
| User Admin | `user-admin-command-center`, `decision-card`, `audit-trace-explorer` | `secure-tenant-user-foundation`, `governance-decisions-audit`, `frontend-shell-integration-patterns` |
