...
- notes:
  ...
  - vertical contract: <workstreamId/functional agent or internal/foundation scope; attention category or non-attention reason; dashboard/surface id/state/action or non-UI trigger; capability id/class; API/exposure channel; selected Akka substrate; events/notifications/projections; audit/work trace; tests/local validation>
