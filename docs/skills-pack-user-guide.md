...
```bash
curl -fsSL https://github.com/mckeeh3/akka-ai-skills-pack/releases/download/v0.2.1/install-akka-ai-skills-pack-0.2.1.sh | bash -s -- --target-dir /path/to/project
```

Install from an unpacked archive:

```bash
tar -xzf akka-ai-skills-pack-0.2.1.tar.gz
cd akka-ai-skills-pack-0.2.1
