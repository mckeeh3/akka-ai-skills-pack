...
class PurchaseOrderEndpointIntegrationTest extends TestKitSupport {
  ...
  void createOrderReturnsCreatedResponse() {
    var orderId = "purchase-order-http-1";
    ...
    var error =
        assertThrows(
            ...
            () ->
                await(
                    httpClient
                        .POST("/purchase-orders/purchase-order-http-2")
                        .withRequestBody(
                            new CreateOrderRequest(
                                "",
  ...
  void getOrderConsistentReturnsCurrentState() {
    var orderId = "purchase-order-http-3";
    ...
    var response =
        await(
            httpClient
                .GET("/purchase-orders/" + orderId + "/consistent")
                .responseBodyAs(OrderResponse.class)
                .invokeAsync());
  ...
  void includeAndExcludeRegionEndpointsReturnStatus() {
    var orderId = "purchase-order-http-4";
    ...
    var includeResponse =
        await(
            httpClient
                .PUT("/purchase-orders/" + orderId + "/replication/include")
    ...
    var excludeResponse =
        await(
            httpClient
                .PUT("/purchase-orders/" + orderId + "/replication/exclude")
                .withRequestBody(new RegionRequest("aws-us-east-2"))
                .responseBodyAs(StatusResponse.class)
                .invokeAsync());
  ...
  void lineItemReadyToShipEndpointUpdatesOrderState() {
    var orderId = "purchase-order-http-5";
    ...
    var firstResponse =
        await(
            httpClient
                .PUT("/purchase-orders/" + orderId + "/line-items/sku-1/ready-to-ship")
                .responseBodyAs(OrderResponse.class)
                .invokeAsync());
    ...
    var secondResponse =
        await(
            httpClient
                .PUT("/purchase-orders/" + orderId + "/line-items/sku-2/ready-to-ship")
                .responseBodyAs(OrderResponse.class)
                .invokeAsync());
