...
```bash
curl -fsSL https://github.com/mckeeh3/akka-ai-skills-pack/releases/download/v0.1.5/install-akka-ai-skills-pack-0.1.5.sh | bash -s --
```

Install into a specific project directory:

```bash
curl -fsSL https://github.com/mckeeh3/akka-ai-skills-pack/releases/download/v0.1.5/install-akka-ai-skills-pack-0.1.5.sh | bash -s -- --target-dir /path/to/project
```

The release installer downloads `akka-ai-skills-pack-0.1.5.tar.gz`, unpacks it in a temporary directory, and runs the bundled installer in project mode.

#### Install from an unpacked archive

```bash
tar -xzf akka-ai-skills-pack-0.1.5.tar.gz
cd akka-ai-skills-pack-0.1.5
...
- `dist/install-akka-ai-skills-pack-0.1.5.sh`
...
- `dist/akka-ai-skills-pack-0.1.5/`
- `dist/akka-ai-skills-pack-0.1.5.tar.gz`
- `dist/install-akka-ai-skills-pack-0.1.5.sh`
...
```bash
tar -xzf dist/akka-ai-skills-pack-0.1.5.tar.gz -C /tmp
cd /tmp/akka-ai-skills-pack-0.1.5
bash install.sh --location project --project /path/to/test/project
```
