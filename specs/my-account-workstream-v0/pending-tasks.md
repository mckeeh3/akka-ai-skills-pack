# Pending Tasks: My Account Workstream v0
...
- Commit message format: `my-account-v0: <short task title>`.

## Tasks

### TASK-MYACCT-00-001: Create My Account Workstream v0 planning scaffold

- status: done
- source: user request for one mini-project per five-core v0 workstream
- task brief: specs/my-account-workstream-v0/tasks/00-planning/00-create-my-account-workstream-v0-queue.md
- depends on: []
- required reads:
  - AGENTS.md
  - skills/README.md
...
- notes:
  - commit message: `my-account-v0: add planning queue`

### TASK-MYACCT-01-001: Define My Account Workstream v0 contract and capability inventory

- status: done
- source: specs/my-account-workstream-v0/backlog/01-my-account-workstream-v0-build-backlog.md
- task brief: specs/my-account-workstream-v0/tasks/01-contract/01-define-workstream-contract.md
- depends on:
  - TASK-MYACCT-00-001
- required reads:
  - AGENTS.md
...
- required checks:
  - `git diff --check`
  - `rg -n "capability|AuthContext|request/response|AutonomousAgent|deterministic|trace|validation" specs/my-account-workstream-v0`
- done criteria:
...
- notes:
  ...
  - checks passed: `git diff --check`; `rg -n "capability|AuthContext|request/response|AutonomousAgent|deterministic|trace|validation" specs/my-account-workstream-v0`
  - commit message: `my-account-v0: define workstream contract`
