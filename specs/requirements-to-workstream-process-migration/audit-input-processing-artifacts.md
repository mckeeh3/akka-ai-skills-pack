...
| `docs/app-description-skills-plan-backlog.md` | drift risk | Historical planning map for app-description skills; useful provenance for normalization/router ownership. | Older layer-oriented wording can reinforce capability/behavior/test/security first. It likely needs either deprecation note or update after skill changes. | Later sprint should decide whether to refresh or mark as historical to avoid stale guidance. |
...
- `docs/app-description-skills-plan-backlog.md` appears older and layer-oriented.
