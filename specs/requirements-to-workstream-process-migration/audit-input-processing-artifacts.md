...
| `templates/ai-first-saas-starter/app-description/README.md` | partially aligned | Preferred starter core reference for secure AI-first SaaS app descriptions; supports workstream-first architecture. | Needs later example-level verification for attention/dashboard/autonomous-task/event projection completeness. | Include in examples/packaging sprint audit and update if it lacks visible attention/dashboard contracts. |
...
1. Verify the starter core app-description shows attention/dashboard/surface/capability/autonomous-task chain for core workstreams.
