...
Update examples, starter core app-description references, starter guidance, and package export lists so downstream installed-pack users see the new process as the normal path.
...
2. Ensure the starter core app-description includes or references dashboard/attention/autonomous-task process guidance.
