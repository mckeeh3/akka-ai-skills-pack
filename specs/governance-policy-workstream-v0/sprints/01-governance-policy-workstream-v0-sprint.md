# Sprint 01: Governance Policy Workstream v0 Vertical

## Objective

Plan and implement the `Governance/Policy Agent` v0 vertical as one focused workstream increment after the shared five-core plan is ready.
