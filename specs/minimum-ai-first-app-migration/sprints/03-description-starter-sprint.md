# Sprint 3: Description and Starter Alignment
...
- Do not perform broad starter implementation unless the task explicitly calls for template edits.
- Do not rewrite unrelated domain examples.

## Acceptance

- Description-first paths can express a minimal tree with User Admin workstream, `markdown_response`, bootstrap auth, workstream log, and traces.
- Starter guidance grows from User Admin v0 to User Admin structured surfaces, Agent Admin, Audit/Trace, and app-specific workstreams.
