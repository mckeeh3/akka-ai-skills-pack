# Agent Admin Workstream v0

## Purpose

Complete the Agent Admin vertical for AgentDefinitions, prompts, skills, references, manifests, model refs, tool boundaries, behavior editing, and governed runtime visibility.
...
The five-core v0 starter already exists as a production-ready baseline. This workstream project plans the next focused vertical increment for the `Agent Admin Agent` without re-planning the other four workstreams.

## Agent-type intent

Agent Admin should deliberately demonstrate request/response behavior editing/help, AutonomousAgent-backed evaluation/improvement or behavior-review batches, and deterministic resolver/authorizer/seed/lifecycle services.
