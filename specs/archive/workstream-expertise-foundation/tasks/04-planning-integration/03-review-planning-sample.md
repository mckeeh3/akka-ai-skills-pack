# Review planning integration with sample

## Objective

Validate planning guidance against a hypothetical domain workstream.
...
Create `sprint-04-review.md`; include a concise sample task outline for a new domain-specific workstream if helpful. Update queue if gaps remain.

## Non-goals

Do not implement the sample workstream.
