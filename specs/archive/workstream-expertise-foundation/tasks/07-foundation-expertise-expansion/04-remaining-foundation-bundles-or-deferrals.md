# Add remaining foundation bundles or deferrals

## Objective

Give Governance/Policy, Mission Control, and My Account explicit expertise status.
...
Do not over-specify app-specific domain behavior.
