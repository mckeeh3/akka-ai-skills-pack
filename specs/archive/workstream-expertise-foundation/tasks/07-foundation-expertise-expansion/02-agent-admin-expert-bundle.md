...
Create/update app-description workstream-expertise artifacts for agent-admin-agent covering prompts, skills, references, manifests, tool boundaries, behavior proposals, approval gates, seed upgrades, denials, traces, and tests.

## Non-goals

Do not implement starter runtime seed resources unless a later task explicitly asks.
