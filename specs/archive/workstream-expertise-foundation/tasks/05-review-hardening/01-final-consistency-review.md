# Run final consistency review

## Objective

Search for stale paths that bypass workstream expertise.
...
Create `final-consistency-review.md` with findings across skills/docs/examples/starter guidance and recommended final cleanup or next sprint.

## Non-goals

Do not apply broad cleanup in the review task.
