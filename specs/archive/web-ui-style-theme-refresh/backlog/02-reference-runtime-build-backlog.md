...
Apply the replacement canonical style and named themes to the repository's starter core app-description and starter/reference frontend assets.

## Implementation notes

- The starter core app-description should describe selected style, available themes, default theme, and My Account theme-selection behavior.
...
1. Update starter core app-description style and My Account theme contracts.
...
- Starter core app-description and starter/reference assets use the same named-theme model.
