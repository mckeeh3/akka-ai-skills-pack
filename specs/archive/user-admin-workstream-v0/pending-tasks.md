...
- notes:
  ...
  - checks passed: `git diff --check`; `rg -n "capability|AuthContext|request/response|AutonomousAgent|deterministic|trace|validation" specs/user-admin-workstream-v0`
