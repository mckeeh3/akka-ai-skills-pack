...
Repeat terminal verification after TASK-017. Close the mini-project only if the done state and required checks are satisfied; otherwise append focused follow-up tasks plus another replacement terminal verification task.
...
- Completed follow-up task notes/commits since TASK-016.
...
- Confirms TASK-016/TASK-017 blockers are resolved or explicitly re-queued.
