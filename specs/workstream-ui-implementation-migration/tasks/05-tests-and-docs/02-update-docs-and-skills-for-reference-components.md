# Task Brief: Update Docs and Skills for Reference Components

## Task

Update repository guidance so future agents know to use the reusable workstream UI reference components.
...
Mark `TASK-WUI-05-002` done after commit.
