...
Apply the replacement style and named-theme model to the starter core app-description and starter/reference frontend assets.

## Scope

- Starter core app-description `55-ui/style-guide.md` and related UI/My Account references.
...
1. Update starter core app-description UI/theme contract.
...
- Starter core app-description records the replacement style and four named themes.
