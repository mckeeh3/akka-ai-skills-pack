# Task Brief: Update Seed App-Description Theme Contract

## Objective

Update the seed app-description UI layer so it uses the replacement workstream style and named-theme model, including simple My Account theme selection semantics.
...
- `git diff --check`
- `rg -n "orange|coral|system with light|system mode|light/dark/system|warm near-black" docs/examples/ai-first-saas-seed-app-description/app-description/55-ui docs/examples/ai-first-saas-seed-app-description/app-description/12-workstreams` and review results for stale contradictions
...
- `ui-theme: update seed app theme contract`
