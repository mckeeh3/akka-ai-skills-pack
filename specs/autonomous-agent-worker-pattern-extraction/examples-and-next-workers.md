...
1. **Audit/Trace scheduled audit summary** — summarize recent security, authorization, capability, agent-work, and provider-readiness traces for authorized audit reviewers. Best when audit trace search and redaction surfaces are stable.
