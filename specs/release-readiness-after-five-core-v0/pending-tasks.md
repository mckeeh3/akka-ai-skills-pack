...
- required checks:
  - `git diff --check`
  - `rg -n "0.2.11|five core|core v0|workstream-oriented core-app domain|older module-sequenced|scaffold-ai-first-saas-starter|validate-ai-first-saas-starter-fullstack" README.md docs/skills-pack-user-guide.md docs/skills-pack-developer-guide.md pack/README.md pack/AGENTS.md pack/manifest.yaml docs/examples/core-ai-first-saas-input/README.md docs/examples/ai-first-saas-core-app-domain/README.md specs/release-readiness-after-five-core-v0/release-handoff.md`
- done criteria:
