# Update traceability/readiness and review foundation expertise

## Objective

Wire all foundation expertise artifacts into traceability and readiness.
...
Update relevant traceability/test/readiness docs, then create specs/workstream-expertise-foundation/sprint-07-review.md confirming every foundation functional agent has bundle or deferral status.

## Non-goals

Do not mark full-core readiness if material bundle gaps remain.
