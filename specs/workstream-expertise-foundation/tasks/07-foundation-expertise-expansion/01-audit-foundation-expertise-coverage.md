# Audit foundation expertise coverage

## Objective

Inventory every foundation functional agent and its expertise status.
...
Create specs/workstream-expertise-foundation/foundation-expertise-coverage-audit.md identifying detailed bundles, missing bundles, and explicit deferral candidates for all foundation functional agents.

## Non-goals

Do not author new bundles in the audit task.
