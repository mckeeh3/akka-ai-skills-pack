...
Create/update app-description workstream-expertise artifacts for audit-trace-agent covering trace search, trace explanation, redaction, sensitive evidence, export limits, denials, support-access audit, references, traces, and tests.

## Non-goals

Do not add broad audit implementation code.
