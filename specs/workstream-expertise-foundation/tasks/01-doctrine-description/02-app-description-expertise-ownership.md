# Add app-description expertise ownership

## Objective

Make app-description artifacts own per-workstream expertise semantics.
...
Do not author the full User Admin expert bundle yet.
