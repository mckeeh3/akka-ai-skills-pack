# Update reference coverage docs

## Objective

Reflect executable reference-governance coverage after backend tests exist.
...
Update docs/agent-coverage-matrix.md and any starter validation documentation/scripts needed to show the first-class reference example and tests.

## Non-goals

Do not claim coverage for features not implemented in Sprint 06.
