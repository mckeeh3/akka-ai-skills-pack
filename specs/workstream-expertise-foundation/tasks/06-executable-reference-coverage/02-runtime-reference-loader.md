# Implement runtime reference manifest and loader

## Objective

Make the starter runtime assemble compact reference manifests and authorize readReferenceDoc calls.
...
Update AgentRuntimeService and related request/result types to render separate skill/reference manifest sections, enforce READ_REFERENCE grants, authorize assigned active references, return safe denials, and emit REFERENCE_LOAD or ReferenceLoadTrace-equivalent traces.

## Non-goals

Do not broaden behavior editing to full reference edit/review UI in this task.
