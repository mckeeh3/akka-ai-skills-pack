# Audit model-binding readiness

## Objective

Determine exactly where per-workstream model binding is still implicit or only documented.
...
Create `specs/workstream-expertise-foundation/model-binding-gap-matrix.md` covering doctrine, skills, app-description, seed bundles, starter runtime, tests, planning/generation, and coverage matrix.

## Non-goals

Do not implement fixes in the audit task.
