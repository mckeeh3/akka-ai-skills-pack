# Apply final cleanup or add next sprint

## Objective

Close small gaps or create a follow-on sprint.
...
Apply the smallest cleanup edits from final review, or add new sprint/backlog/task files and update queue if material work remains.

## Non-goals

Do not mark the whole plan complete if material gaps remain.
