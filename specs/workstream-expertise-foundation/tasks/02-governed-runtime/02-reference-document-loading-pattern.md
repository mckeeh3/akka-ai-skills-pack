# Define reference-document loading pattern

## Objective

Define how workstream reference docs are governed and loaded.
...
Update or add focused guidance for ReferenceDocument/ReferenceVersion/AgentReferenceManifest/readReferenceDoc or a constrained SkillDocument-based first pass. Include authorization, denial, trace, and authority rules.

## Non-goals

Do not update seed examples yet.
