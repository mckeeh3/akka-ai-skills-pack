...
This file defines the scaffolded core app description's AI-first browser surfaces as typed workstream artifacts, independently from route mechanics. These surfaces are the UI contract for delegated work, retained human authority, evidence-backed decisions, policy governance, audit traces, and outcome loops.
...
- primary workstream placement: Governance Workbench
...
## Governance/Policy Briefing

- primary workstream placement: Briefing / Governance/Policy
...
- primary workstream placement: Briefing / Governance/Policy digest regions
- route/deep-link support: `/ui/briefing`
