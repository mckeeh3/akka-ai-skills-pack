...
- `POST /api/admin/memberships/{membershipId}/status` (`admin.memberships.suspend` / `admin.memberships.reactivate`)
- `POST /api/admin/memberships/{membershipId}/roles/preview` (`admin.roles.preview`)
- `POST /api/admin/memberships/{membershipId}/roles` (`admin.roles.replace`)
...
- `POST /api/admin/support-access/{membershipId}/grant` (`admin.support_access.grant`)
- `POST /api/admin/support-access/{membershipId}/revoke` (`admin.support_access.revoke`)
- `POST /api/admin/support-access/{membershipId}/extend` (`admin.support_access.extend`)
- `POST /api/admin/access-review` (`admin.access_review.start`)
- `GET /api/admin/access-review/{taskId}` (`admin.access_review.read`)
- `POST /api/admin/access-review/{taskId}/cancel` (`admin.access_review.cancel`)
- `POST /api/admin/access-review/{taskId}/accept` (`admin.access_review.accept_result`)
- `POST /api/admin/access-review/{taskId}/reject` (`admin.access_review.reject_result`)
- `GET /api/admin/audit-events` (`admin.audit.read`)
...
- `topics=governance-policy,goals,decisions,governance,notifications`
...
type RealtimeEvent = {
  eventId: string;
  tenantId: string;
  topic: "governance-policy" | "goals" | "decisions" | "governance" | "notifications";
  type: string;
  subjectId: string;
  version?: number;
  occurredAt: string;
