...
- remaining slices: event-sourced invitation lifecycle history, richer event-sourced PromptDocument/SkillDocument/ReferenceDocument/manifest/ToolPermissionBoundary lifecycle history, InvitationView/UserDirectoryView/AdminAuditView/governed-agent projections, extended foundation projections beyond the starter's current Akka-backed scope, broader event coverage beyond the bounded v3 starter event families, future SMS/mobile-push/webhook/Slack/Teams delivery channels and broad notification analytics/platform capabilities beyond the implemented in-app notification center and Resend-backed email delivery channel, broader task/AutonomousAgent notification coverage beyond the implemented access-review, prompt-risk, personal-digest, audit-summary, and governance-impact queued/running/blocked/failed/completed-review/cancelled/accepted/rejected starter states, future digest-platform work beyond the bounded My Account personal attention digest and Audit/Trace summary workers, and a future policy simulation platform beyond the bounded Governance/Policy impact-analysis worker.
