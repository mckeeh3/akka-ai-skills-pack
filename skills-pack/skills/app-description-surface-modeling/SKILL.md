...
- `../templates/ai-first-saas-core-app/app-description/README.md` and its `12-workstreams/**`, `55-ui/**`, and `70-traceability/**` files when bootstrapping or repairing SaaS Foundation App surface contracts
