...
- default-content provenance, default first versions, first-install document setup, tenant bootstrap, starter prompts/skills, or implementation-defined behavior defaults
