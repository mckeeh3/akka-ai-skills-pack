...
- For minimum starter generation, the description/spec must satisfy five core workstream starter readiness and must emit follow-up tasks for full-core SaaS readiness.
