...
For new Java generation/scaffolding, use the fixed Java base package `ai.first`. Do not create or ask a Java base-package question, and package selection is out of scope.
