...
- `specs/akka-solution-plan.md` only if architectural choices, AI-first operating model, requirements-to-workstream contract, workstream expertise foundation, authority boundaries, core-baseline/five-core/full-core readiness, or global implementation order changed
