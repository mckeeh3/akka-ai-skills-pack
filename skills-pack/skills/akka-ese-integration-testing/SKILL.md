...
Pattern references:
- target-project endpoint integration tests for the entity-backed API under test
...
Pattern references:
- target-project consumer-driven integration tests for the entity event flow under test
