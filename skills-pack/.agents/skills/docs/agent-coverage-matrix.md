...
- Need user-facing functional/context-area agents in a generated SaaS workstream app: read `./agent-workstream-application-architecture.md`, `../agent-workstream-apps/SKILL.md`, then `../akka-agents/SKILL.md`.
...
- Need to choose between request-based Agent, AutonomousAgent, Workflow, Workflow + Agent, or Workflow + AutonomousAgent: read `./agent-component-selection-guide.md`.
