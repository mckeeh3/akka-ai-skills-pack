...
public final class AgentBehaviorSeedLoader {
  ...
  private List<ReferenceSeed> userAdminReferenceSeeds() {
    return List.of(
        ...
        new ReferenceSeed(LAST_ADMIN_PROTECTION_REFERENCE_DOC_ID, "ua.last-admin-protection.v1", "Last Admin Protection Rule", "Blocked removal, disablement, or role downgrade and safe recovery.", "Consult when a requested change could remove, disable, or downgrade the last organization admin.", ReferenceDocument.ReferenceType.DOMAIN_RULE, "internal", "/agent-behavior-seeds/starter-v1/last-admin-protection-reference.md", "references/user-admin/last-admin-protection.md"),
