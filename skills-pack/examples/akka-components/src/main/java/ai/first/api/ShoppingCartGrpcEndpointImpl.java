...
import ai.first.api.grpc.AddItemRequest;
import ai.first.api.grpc.Cart;
import ai.first.api.grpc.CartItem;
import ai.first.api.grpc.CartStatusResponse;
import ai.first.api.grpc.CartSummary;
import ai.first.api.grpc.CheckedOutCartsRequest;
import ai.first.api.grpc.CheckoutCartRequest;
import ai.first.api.grpc.DeleteCartRequest;
import ai.first.api.grpc.GetCartRequest;
import ai.first.api.grpc.ShoppingCartGrpcEndpoint;
import ai.first.application.ShoppingCartEntity;
import ai.first.application.ShoppingCartsByCheckedOutView;
