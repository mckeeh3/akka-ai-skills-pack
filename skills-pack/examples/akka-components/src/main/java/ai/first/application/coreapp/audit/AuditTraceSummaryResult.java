...
public record AuditTraceSummaryResult(
    ...
    List<AuditTraceSummaryFinding> findings,
    List<AuditTraceSummaryFinding> providerReadinessFindings,
    List<AuditTraceSummaryFinding> authorizationDenialFindings,
    List<AuditTraceSummaryFinding> agentWorkFindings,
  ...
  public enum OverallRisk { CLEAR, WATCH, REVIEW_REQUIRED, CRITICAL_REVIEW_REQUIRED }

  public record AuditTraceSummaryFinding(
      String findingId,
      String category,
      String severity,
      String title,
    ...
    public AuditTraceSummaryFinding {
      evidenceRefs = List.copyOf(evidenceRefs == null ? List.of() : evidenceRefs);
      traceRefs = List.copyOf(traceRefs == null ? List.of() : traceRefs);
    }
  }
