...
public final class AuditTraceSummaryTasks {
  ...
  public static final String EVIDENCE_TOOL_ID = "auditTraceSummaryEvidence.read";
  ...
  public static final Task<AuditTraceSummaryResult> SUMMARIZE_AUDIT_WINDOW =
      Task.name("AuditTraceSummary")
