...
A bootstrap-authorized user can enter the app, operate in a selected `AuthContext`, and use the My Account, User Admin, Agent Admin, Audit/Trace, and Governance/Policy functional agents through durable workstream timelines whose first structured surfaces are `markdown_response`.
