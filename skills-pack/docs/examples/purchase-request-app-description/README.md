...
- in a real development project using the harness skills-library install, the actual maintained `app-description/` tree should live in that project workspace rather than inside `.agents/`, unless the project deliberately chooses another internal location
