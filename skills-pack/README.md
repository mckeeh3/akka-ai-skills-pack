...
- `docs/` — source-attention doctrine, routing, and reference docs; start with `docs/generated-saas-canonical-doctrine.md` for shared generated-app rules, `docs/web-ui-docs-index.md` for UI guidance, and `docs/skill-consolidation-and-pruning.md` for pack-tightening policy
