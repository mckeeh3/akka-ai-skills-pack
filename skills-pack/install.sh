...
[[ -d "$PACK_ROOT/skills" ]] || fail "Expected skills at $PACK_ROOT/skills"
[[ -f "$PACK_ROOT/pack/manifest.yaml" ]] || fail "Expected manifest at $PACK_ROOT/pack/manifest.yaml"
...
log "Pack source:       $PACK_ROOT"
log "App source:        $APP_ROOT"
...
copy_file "$PACK_ROOT/pack/manifest.yaml" "$PACK_MANIFEST_TARGET"
copy_file "$PACK_ROOT/pack/AGENTS.md" "$AGENTS_ROOT/AGENTS.md"
install_project_agents_guidance
copy_file "$PACK_ROOT/skills/README.md" "$SKILLS_DIR/README.md"
copy_dir_replace "$PACK_ROOT/skills/references" "$SKILLS_DIR/references"
...
copy_dir_replace "$PACK_ROOT/docs" "$DOCS_DIR"
