...
Structured surfaces are the browser/user-visible contract for workstream state. `markdown_response` v1 is the first common surface for the five core core workstreams; richer typed surfaces are added as core readiness improves.
