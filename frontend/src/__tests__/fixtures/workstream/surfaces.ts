...
export const userAdminSurfaceActions = {
  ...
  openInvitationCreate: {
    ...
    shellRequest: { requestType: 'show_surface', targetFunctionalAgentId: 'agent-user-admin', targetSurfaceId: 'surface-user-admin-invitation-create', displayText: 'Invite user' },
    idempotency: { required: false },
