...
test('User Admin dashboard and list surfaces model the command-center contract', () => {
...
test('workstream and fixture client support dashboard-to-list navigation feedback', () => {
...
test('composer show users opens the User Admin list/search surface instead of a page route', () => {
