...
export class HttpApiClient implements ApiClient {
  ...
  constructor(private readonly tokenProvider?: TokenProvider, private readonly selectedContextIdProvider?: SelectedContextIdProvider) {
    ...
    this.admin = {
      ...
      archiveOrganization: (organizationId, request) => this.post(`/api/admin/organizations/${encodeURIComponent(organizationId)}/archive`, request),
      ...
      archiveCustomer: (customerId, request) => this.post(`/api/admin/customers/${encodeURIComponent(customerId)}/archive`, request),
