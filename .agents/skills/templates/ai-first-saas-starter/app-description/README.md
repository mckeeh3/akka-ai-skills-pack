# AI-first SaaS starter app-description template

This template is a source-controlled starter for workstream surface modeling in generated secure AI-first SaaS apps. Copy the smallest relevant files into a target project's `app-description/` tree when bootstrapping or repairing surface contracts.
