...
| Open profile | `account.profile.read` | browser-tool surface-request | profile/settings surface or `markdown_response` starter fallback |
| Open settings | `account.settings.read` | browser-tool surface-request | settings surface or `markdown_response` starter fallback |
